...
#  load_and_authorize_resource
  ...
  private
    ...
    def poi_address_params
      params.require(:poi_address).permit(:city_id, :street, :number, :neighborhood, :block, :house, :user_id, :source, :latitude, :longitude, :p_action_id, :city_name, :department_name, :province_name, :country_name, :phone, :web, :name, :the_geom).merge(user_id: current_user.id)
