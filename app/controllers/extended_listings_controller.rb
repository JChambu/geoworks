...
=end    end
  ...
  def extended_listing_params
    params.require(:extended_listing).permit(:name, :street, :the_geom, :city_id,  :category_id, :phone, :source, :address, :number, :address, :number, :poi_status_id, :category_original_id, :latitude, :longitude, :poi_type_id, :poi_sub_type_id, :website, :email, :user_id, :phone_2, :street_2, :street_3, :comments)
  end
end
