...
Navarra.poi_addresses.action_edit = function(){
  ...
  loadLatLonFieldsPa = function() {
    ...
    bindAddMarkerButtonClickPa = function() {
      $("#add-marker-new-pa").click(function(e) {
        e.preventDefault();
        $(this).toggleClass("btn-success");
        map.addEventListener('tap', onMapClickPa);
      });
    }


  addMarkerPa = function(lat, lng){

    $("#poi_address_latitude").attr("value", lat)
    $("#poi_address_longitude").attr("value", lng)
    text = "A";
    color = 'green';
  ...
  bindSuggestButtonClickPa = function() {
    $("#suggest-locations-btn-pa").click(function(e) {
      e.preventDefault();
  ...
  onMapClickPa= function(evt) {
    ...
    addSelectedMarkerPa(coord.lat, coord.lng);
  },

    addSelectedMarkerPa = function(lat, lon) {
      if(!lat || !lon) {
        return;
      }

      $("#poi_address_latitude").attr("value", lat)
      $("#poi_address_longitude").attr("value", lon)
