...
if (subdomain == "lvh.me"){
  ...
  var layer_geoserver_cobertura_bar = 'geoworks_lvh:cobertura';
...
if (subdomain == "supercanal.geoworks.gisworking.com"){
  ...
  //    var layer_geoserver_geomainid = 'http://localhost:8080/geoserver/geoworks_lvh/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=geoworks_lvh:geomanid&maxFeatures=50&outputFormat=application%2Fjson'
   ...
   var layer_geoserver_manzana = 'geoworks_supercanal:manzanas';
    ...
    var layer_geoserver_gw_status_desfasaje = 'http://geoworks.gisworking.com:8080/geoserver/geoworks_supercanal/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=geoworks_supercanal:gw_status_desfasaje&maxFeatures=30050&outputFormat=application%2Fjson'
