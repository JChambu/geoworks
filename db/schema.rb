...
ActiveRecord::Schema.define(version: 20231004000434) do
  ...
  create_table "datos_reportes", id: :serial, force: :cascade do |t|
    t.string "nombre"
    t.integer "project_typ_id"
  end

  create_table "datos_tableros", id: :serial, force: :cascade do |t|
    t.string "nombre"
    t.integer "project_typ_id"
  end
  ...
  create_table "propiedades_reporte", id: :serial, force: :cascade do |t|
    t.integer "datos_reporte_id"
    t.integer "tipo_elemento"
    t.integer "ancho"
    t.integer "labels_grafico"
    t.text "data_sets_grafico"
    t.text "options_grafico"
    t.string "logo"
    t.string "alineacion"
    t.text "margen_i"
    t.string "titulo"
    ...
    t.text "margen_d"
    t.text "comentario"
    t.string "color_vineta"
    t.text "bordeiz_tabla"
    t.text "bordesu_tabla"
    t.text "bordede_tabla"
    t.text "bordein_tabla"
    t.text "datos_tabla"
    t.text "color_tabla"
    t.integer "letra"
    t.integer "elemento"
    t.integer "mostrar_valores_grafico"
    t.text "uniones_grafico"
    t.integer "alto"
    t.integer "top"
    ...
    t.text "intervalo"
    t.text "subintervalo"
    t.integer "filas_crono"
    t.text "detalle_crono"
    t.string "ocultar_crono"
  end

  create_table "propiedades_tablero", id: :serial, force: :cascade do |t|
    t.integer "datos_tablero_id"
    t.integer "tipo_elemento"
    t.integer "ancho"
    t.integer "labels_grafico"
    t.text "data_sets_grafico"
    t.text "options_grafico"
    t.string "nombre_indicador"
    t.integer "indicador"
    t.integer "operador_indicador"
    t.integer "mostrar_valores_grafico"
    t.text "uniones_grafico"
    t.integer "alto"
  end
  ...
  create_table "service_apps", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_service_apps_on_name", unique: true
  end
  ...
  add_foreign_key "api_connections", "project_types"
